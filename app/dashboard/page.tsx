      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-6">
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white">Loading Dashboard...</h1>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {metrics.map((metric, index) => (
            <Card
              key={metric.title}
              className="card-gradient hover-lift hover-glow border-0"
            >
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* AI Document Review */}
          <Card className="card-dark hover-glow border-0">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
